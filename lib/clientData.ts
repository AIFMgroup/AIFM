...
export const mockDocuments: UploadedDocument[] = [
  // TechStart AB documents
  {
    ...
    extractedData: {
      ...
      vatRate: 25,
      currency: 'SEK',
      description: 'Molntjänster - November 2024',
      category: 'IT & Mjukvara',
    },
    bookingEntry: {
      id: 'be-1',
      documentId: 'doc-1',
  ...
  // Green Energy Solutions documents
  {
    ...
    extractedData: {
      ...
      category: 'Maskiner & Inventarier',
      lineItems: [
        { description: 'Solpaneler 450W x 500st', quantity: 500, unitPrice: 3500, amount: 1750000, vat: 437500 },
        { description: 'Installation & montage', quantity: 1, unitPrice: 500000, amount: 500000, vat: 125000 },
