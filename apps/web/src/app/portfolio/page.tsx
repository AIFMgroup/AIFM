  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden md:flex items-center gap-6">
                ...
                <Link href="/portfolio" className="text-sm font-medium text-aifm-gold uppercase tracking-wider">Portfölj</Link>
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-12 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <h1 className="heading-2">Portföljövervakning</h1>
              <HelpTooltip 
        ...
        {/* Sector Breakdown */}
        <div className="bg-white rounded-2xl border border-gray-100 shadow-aifm p-6 mb-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {portfolio.map((company) => {
              ...
              return (
                <div 
                  key={company.id}
                  className="bg-white rounded-2xl border border-gray-100 shadow-aifm hover:shadow-aifm-lg transition-all cursor-pointer group"
