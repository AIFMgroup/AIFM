...
/**
 * GET /fortnox/bootstrap?companyId=xxx
 * Returns bootstrap-status and stats (non-/api path to avoid CloudFront routing conflicts).
 */
...
/**
 * POST /fortnox/bootstrap?companyId=xxx
 * Starts bootstrap (chart of accounts, dimensions, suppliers, articles).
 */
